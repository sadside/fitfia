...
export const Sidebar = ({}: SidebarProps) => {
    ...
    return (
        <ul className={styles.optionList}>
            <li className={`${styles.optionListItem} ${active === '' && `${styles.active}`}`} onClick={() => setActive('')}>
                <NavLink to="/" onMouseEnter={play}>
                    <a>Задания</a>
                </NavLink>
            </li>
            <li className={`${styles.optionListItem} ${active === 'news' && `${styles.active}`}`} onClick={() => setActive('news')} >
                <NavLink to="/news" onMouseEnter={play}>
                    <a>Новости</a>
                </NavLink>
            </li>
            <li className={`${styles.optionListItem} ${active === 'profile' && `${styles.active}`}`} onClick={() => setActive('profile')} >
